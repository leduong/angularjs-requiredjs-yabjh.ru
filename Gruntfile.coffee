...
module.exports = (grunt) ->
	...
	grunt.initConfig
		...
		watch:
			coffee:
				files: ["<%= yeoman.app %>/js/**/*.coffee", "!<%= yeoman.app %>/js/vendor/**/*.coffee"]
				tasks: ["coffee:dist"]
		...
		jshint:
			...
			all: ["Gruntfile.js", "<%= yeoman.app %>/js/**/*.js", "!<%= yeoman.app %>/js/vendor/**/*.js"]
		...
		copy:
			dist:
				...
				,
					...
					src: ["js/vendor/font-awesome/fonts/*"]
				,
					expand: true
					flatten: true
					cwd: "<%= yeoman.app %>"
		...
		uglify:
			...
			dist:
				files:
					"<%= yeoman.dist %>/js/main.js": [".tmp/**/*.js", "<%= yeoman.app %>/js/**/*.js", "!<%= yeoman.app %>/js/vendor/**/*.js"]
	...
	grunt.registerTask "build", [
		...
		#"html2js"
		"useminPrepare"
		"concurrent:lessServer" #"concurrent:dist"
		"copy:dist"
		"concat"
		"uglify"
		"usemin"
